...
新增要求（结构）：
- 如果返回 milestones，请尽量给 tasks 添加 milestone_index（0-based）来表示归属里程碑
- 也可使用 milestones[i].tasks 嵌套任务；但任务字段必须完整（title/due_at/evidence_type）
- 可以保留少量不属于里程碑的 tasks 作为“相关任务”
"""
