...
def run_test():
    ...
    # Call V2 route
    print("Calling /tasks/weekly-system-check-v2...")
    try:
        headers = {"Authorization": f"Bearer {token}"}
        resp = requests.post(f"http://localhost:8000/api/tasks/weekly-system-check-v2", headers=headers, json={})
